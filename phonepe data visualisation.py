...
st.title("Phonepe Pulse Data Analyse")
...
a=['west bengal','andaman & nicobar islands','chandigarh','dadra & nagar haveli & daman & diu','delhi','haryana','jharkhand',
 'karnataka','kerala','lakshadweep','madhya pradesh','maharashtra','puducherry','tamil nadu','chhattisgarh','telangana','andhra pradesh',
 'goa','himachal pradesh','punjab','rajasthan','gujarat','uttarakhand','uttar pradesh','sikkim','assam','arunachal pradesh',
 'nagaland','manipur','mizoram','tripura','meghalaya','bihar','ladakh','jammu & kashmir','odisha']
for i in range(len(india_state['features'])):
...
fig=px.choropleth(data,
             geojson=india_state,    
              locations="State_id",
              color='Transaction_counts',  #dataframe
              color_continuous_scale='greens',
               title='Transaction_counts across the states' ,  
               #height=700
              )
...
#------------------------------------------------------------------------------------------------------------------------------------------#
st.header('Transctions Analysis Statewise')
...
#------------------------------------------------------------------------------------------------------------------------------------------
#container1,container2=st.container(2)
...
st.plotly_chart(fig)
#------------------------------------------------------------------------------------------------------------------------------------------
st.subheader('Growth analysis of a Brand in all Over India:')
...
#------------------------------------------------------------------------------------------------------------------------------------------
with st.sidebar:
    st.header("Top Registeratered Users/Transactions Data")
    option=st.selectbox("Select",('Registered Users','Transactions','Brand'),key='opt3')
